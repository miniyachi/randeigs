...
for i = 1:length(name_list)
    ...
    lambdatrues = eigs(A,K,'largestabs','MaxIterations',50,'SubspaceDimension',300);
    ...
    save_dir_stem = fullfile('results/restarting', matclass, name);
    ...
    save_filename = strcat(name, '_EigvalsErrors_noorder_', sprintf('m=%d', m), '.mat'); % saved errors file name: {name}_EigvalsErrors_m={m}.mat
    save(fullfile(save_dir_stem, save_filename), 'classical_errs', 'rand_errs', 'eigs_errs', 'maxiter_list', 'm');
